...
$cars = [["id"=>"0","maker"=>"Toyota","model"=>"Corolla","year"=>"2015","engine"=>"petroleum","price"=>"30000","additional"=>["tax","investment"]],
["id"=>"1","maker"=>"BMW","model"=>"X5","year"=>"2012","engine"=>"gas","price"=>"25000","additional"=>["tax","investment","check"]],
["id"=>"2","maker"=>"Toyota","model"=>"Camry","year"=>"2008","engine"=>"diesel","price"=>"35000","additional"=>["investment","check"]]];
$selected_car = NULL;
...
<form action="9.3.php" method="post">
    ...
    <table>
      ...
      <tr>
        <td>Additional:</td>
        <td>
        <input type="checkbox" name="text1" value="yes" <?php if($selected_car!=NULL && in_array('tax', $selected_car['additional'])){echo ' checked ';} ?>> tax payed<br>
       <input type="checkbox" name="text2" value="yes" <?php if($selected_car!=NULL&& in_array('check',$selected_car['additional'])){echo ' checked ';} ?> > technical check passed<br>
        <input type="checkbox" name="text3" value="yes" <?php if($selected_car!=NULL&&in_array('investment',$selected_car['additional'])){echo ' |" ';} ?> >doesn't require investment<br>
        </td>
      </tr>
    </table>
