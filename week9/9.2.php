...
<form action="task9_2_submit.php">
    <table>
      ...
      <tr>
        <td>Additional:</td>
        <td>
        <input type="checkbox" name="text1" value="yes"> tax payed<br>
       <input type="checkbox" name="text2" value="yes"> technical check passed<br>
      <input type="checkbox" name="text3" value="yes" checked>doesn't require investment<br>
        </td>
      </tr>
    </table>
